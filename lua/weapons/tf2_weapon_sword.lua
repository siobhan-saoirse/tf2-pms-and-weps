...
self:SetWeaponHoldType( self.HoldType )
self.Weapon:SendWeaponAnim( _G["ACT_VM_DRAW_SPECIAL"] )
...
if (math.random(1,6) == 1) then
    ...
    self.Crit = true
    self.Weapon:SendWeaponAnim( _G["ACT_VM_SWINGHARD_SPECIAL"] )
else
    self.Owner:EmitSound( self.Primary.Sound )
    self.Weapon:SendWeaponAnim( _G["ACT_VM_HITCENTER_SPECIAL"] )
    self.Crit = false
end
end
