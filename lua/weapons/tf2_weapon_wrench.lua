if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID( "backpack/weapons/w_models/w_wrench" )
SWEP.DrawWeaponInfoBox = false
SWEP.BounceWeaponIcon = false
killicon.Add( "tf2_weapon_wrench", "hud/dneg_image_wrench", Color( 255, 255, 255, 255 ) )
end
...
if SERVER then
self.Owner:StopSound( "player/engineer_no.wav", 95, 100, 1, CHAN_VOICE )
