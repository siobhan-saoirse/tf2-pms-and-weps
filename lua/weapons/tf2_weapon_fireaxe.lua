if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID( "backpack/weapons/w_models/w_fireaxe" )
SWEP.DrawWeaponInfoBox = false
SWEP.BounceWeaponIcon = false
killicon.Add( "tf2_weapon_fireaxe", "hud/dneg_image_fireaxe", Color( 255, 255, 255, 255 ) )
end
